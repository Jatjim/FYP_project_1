...
@section('content')
    ...
    <div class="row">
        @component('components.widget')
            ...
            @endslot
            @slot('body')
                    <button class="btn btn-success" data-toggle="modal" data-target="#addHR"><i class="fa fa-plus-square"></i> Add new HR</button>
                    ...
                    <table  id="sTBL" class="table table-bordered table-hover">
                        ...
                        @foreach ($HR as $HR)
                            <tr>
                                ...
                                @if($HR->publication_status==1)
                                    <td>

                                        <label style="margin-bottom:0px;"class="switch">
                                            <a href="{{URL::to('/unpublished-HR/'.$HR->id)}}">
                                ...
                                @else
                                    <td>
                                        <label style="margin-bottom:0px;"class="switch">
                                            <a href="{{URL::to('/published-HR/'.$HR->id)}}">
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-success" onclick="getInfo('{{$HR->id}}');" data-toggle="modal" data-target="#editEmp"><i class="fa fa-pencil"></i> Edit</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Edit HR</h4>
                </div>
    ...
    <div class="modal fade" id="addHR">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table  class="table">
                        <form method="POST" action="/save-HR">
                        {{ csrf_field() }}
                        <tbody>
                        <tr>
                            <td></td>
