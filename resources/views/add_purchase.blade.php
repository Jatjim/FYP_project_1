...
<script>
    ...
    function HRcheck(selTag) {
        Supplier_name = selTag.options[selTag.selectedIndex].text;
        HRID = selTag.options[selTag.selectedIndex].value;
        document.getElementById('display_HR').innerHTML = Supplier_name;
    ...
    function changeDetect(r, index) {
        ...
        if (index == 1)
            dataStaff[i - 1].Staff = document.getElementById('pName' + i).value;
        else if (index == 2)
            dataStaff[i - 1].size = document.getElementById('sizeInput' + i).value;
        else if (index == 3) {
            dataStaff[i - 1].quantity = document.getElementById('qauntityInput' + i).value;
            document.getElementById('total' + i).innerHTML = Math.ceil(dataStaff[i - 1].quantity * dataStaff[i - 1].price);
        } else if (index == 4) {
            dataStaff[i - 1].price = document.getElementById('priceInput' + i).value;
            document.getElementById('total' + i).innerHTML = Math.ceil(dataStaff[i - 1].quantity * dataStaff[i - 1].price);
    ...
    function addData() {
        ...
        if (alertBrand == -1)
            ...
            var s = '<button class="btn btn-danger btn-sm" onclick="delete_Staff(this);"><i class="fa fa-trash-o"></i></button>'

            var cell5 = row.insertCell(5);
            cell1.innerHTML = "<input type='text'  onkeyup='changeDetect(this,1)' id='pName" + sizeRow + "' value='" + StaffName + "' style='width:100%';>";
...
<?php
    $all_published_HR = \App\HR::all()
        ->where('publication_status',1);
    $all_published_style = \App\StaffCategory::all()
        ->where('status',1);
    $all_published_brand = \App\Brand::all()
        ->where('publication_status',1);

   ///Purchase ID creation
    $boxID = \App\ApprovalPurchase::select('boxID')
        ->orderBy('boxID', 'desc')
        ->get();
    if(sizeof($boxID)==0)
        $invoice_boxID=55005;
...
?>
        ...
        <div class="col-md-5">
            <div class="box box-default box-solid">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title">Add new Staffs to Approval</h3>
                    <a href="#addHR" role="button" class="btn btn-warning btn-sm  pull-right" title="Add new HR" data-toggle="modal"><i class="fa fa-user-plus" ></i></a>



                    <!-- /.box-tools -->
                </div>
                <span class="callout text-danger"> Follow the steps to add new Staffs.</span>
                            ...
                            <div class="">
                                <div class="col-md-7">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            <td><label class="control-label">HR:</label></td>
                                            <td> <select class="form-control select2" id="HRId" onchange="HRcheck(this)" style="width: 100%;">
        ...
        <div class="col-md-7">
            ...
            <div class="box box-widget widget-user-2">
                ...
                <div class="widget-user-header">
                    ...
                    <h5 class="widget-user-desc">Approval invoice history</h5>
                    <span class="col-sm-4">
                            ...
                            <label class="text-danger" style="font-size:13px;">HR: </label>
                            <label id="display_HR" class="label" style="font-size:13px; color:black; "> Not selected </label>
                            <br>
                ...
                <div class="box-body">
                    ...
                    <table id="hist_table" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th><i class="fa fa-sort"></i> Staff </th>
                    ...
                    <br>
                    <button class="btn btn-sm btn-danger" onclick="saveApprovalData()">Save all data</button>
        ...
        <div class="modal fade" id="addHR">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Add new HR</h4>
                    </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="submit" onclick="SaveHRDetails()" data-dismiss="modal" class="btn btn-success btn-sm">SAVE</button>
                                    </td>
                                    <td></td>
