    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="/" class="logo">
                ...
                <span class="logo-lg">Approval Home</b></span>
            </a>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('/add-Approval')}}"><i class="fa fa-clone"></i> Add Approval</a></li>
                            <li><a href="{{URL::to('/Approval-manage')}}"><i class="fa fa-leaf"></i> Manage Approval</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{URL::to('/HR')}}"><i class="fa fa-clone"></i> Manage suppliers</a></li>
                            <li><a href="{{URL::to('/HRPayment')}}"><i class="fa fa-money"></i> Payment</a></li>
                        </ul>
                    </li>
                </ul>
