...
var TimeGrid = FC.TimeGrid = Grid.extend(DayTableMixin, {
	...
	computeLabelInterval: function(slotDuration) {
		...
		// find the smallest Approval label interval that results in more than one slots-per-label
		for (i = AGENDA_Approval_SUB_DURATIONS.length - 1; i >= 0; i--) {
			labelInterval = moment.duration(AGENDA_Approval_SUB_DURATIONS[i]);
...
var AGENDA_Approval_SUB_DURATIONS = [
	{ hours: 1 },
	{ minutes: 30 },
	{ minutes: 15 },
	{ seconds: 30 },
